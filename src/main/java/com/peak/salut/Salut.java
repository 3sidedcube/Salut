...
public class Salut implements WifiP2pManager.ConnectionInfoListener
{
	...
	public void onConnectionInfoAvailable(final WifiP2pInfo info)
	{
		...
		{
			if (info.groupOwnerAddress == null || info.groupOwnerAddress.getHostAddress().isEmpty())
			{
...
//		wifiManager.setWifiEnabled(false);
	...
	private void createService(String alertId, int alertType, final SalutCallback onSuccess, final SalutCallback onFailure)
	{
		...
		thisDevice.txtRecord.put(ALERT_ID, String.valueOf(alertId));
		thisDevice.txtRecord.put(ALERT_TYPE_ID, String.valueOf(alertType));
	...
	public void startNetworkService(String alertId, int alertType, @Nullable SalutDeviceCallback onDeviceRegisteredWithHost, @Nullable SalutCallback onSuccess, @Nullable SalutCallback onFailure)
	{
		...
		createService(alertId, alertType, onSuccess, onFailure);
